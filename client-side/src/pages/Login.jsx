      ...
      <section class="bg-white">
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            <img alt="Night" src="https://i.pinimg.com/564x/53/63/92/536392c64a34b43032e90130f70640a9.jpg" class="absolute inset-0 h-full w-full object-cover opacity-80" />
            ...
            <div class="hidden lg:relative lg:block lg:p-12">
              ...
              <h2 class="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">Welcome to Erigo</h2>
