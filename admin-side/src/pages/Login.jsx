      ...
      <section class="bg-white">
        <div class="lg:grid lg:min-h-screen lg:grid-cols-12">
          <section class="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
            <img alt="Night" src="https://i.pinimg.com/564x/85/42/8d/85428d6d5737580b85717ba71993d332.jpg" class="absolute inset-0 h-full w-full object-cover opacity-80" />
            ...
            <div class="hidden lg:relative lg:block lg:p-12">
              ...
              <h2 class="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">Welcome to Erigo Admin</h2>
          ...
          <main aria-label="Main" class=" bg-[url('https://i.pinimg.com/564x/da/65/c5/da65c525db2f88aebc6ee1b669809a8c.jpg')] flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:py-12 lg:px-16 xl:col-span-6">
            <div class="max-w-xl lg:max-w-3xl">
              <div class="relative -mt-16 block lg:hidden">
                ...
                <h1 class="mt-2 text-2xl font-bold text-gray-900 sm:text-3xl md:text-4xl">Welcome to Erigo Admin</h1>
